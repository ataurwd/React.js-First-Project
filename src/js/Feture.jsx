...
const Feture = () => {
    return (
<section className=" py-5 rounded-xl md:m-8 dark:bg-gray-100 dark:text-gray-800 bg-red-100 mx-0">
	...
	<div className="container grid justify-center gap-4 mx-auto lg:grid-cols-2 xl:grid-cols-4 pb-8 *:pb-3">
        {/* first */}
		<div className="flex flex-col px-8 py-6 bg-pink-300 rounded-xl">
            <img className=" w-[40%]" src="https://cdn-icons-png.flaticon.com/128/6415/6415499.png" alt="" />
        ...
        {/* second */}
		<div className="flex flex-col px-8 py-6 bg-pink-300 rounded-xl">
            <img className=" w-[40%]" src="https://cdn-icons-png.flaticon.com/128/6348/6348276.png" alt="" />
        ...
        {/* third */}
		<div className="flex flex-col px-8 py-6 bg-pink-300 rounded-xl">
        <img className=" w-[40%]" src="https://cdn-icons-png.flaticon.com/128/6863/6863985.png" alt="" />
        ...
        {/* last */}
		<div className="flex flex-col px-8 py-6 bg-pink-300 rounded-xl">
        <img className=" w-[40%]" src="https://cdn-icons-png.flaticon.com/128/922/922699.png" alt="" />
